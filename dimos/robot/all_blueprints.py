...
all_blueprints = {
    ...
    "drone-px4-swarm-agentic": "dimos.robot.drone.blueprints.agentic.drone_px4_swarm_agentic:drone_px4_swarm_agentic",
    "drone-px4-swarm-hardware": "dimos.robot.drone.blueprints.basic.drone_px4_swarm_hardware:drone_px4_swarm_hardware",
    "drone-px4-swarm-hardware-agentic": "dimos.robot.drone.blueprints.agentic.drone_px4_swarm_hardware_agentic:drone_px4_swarm_hardware_agentic",
    "drone-px4-swarm-hardware-rtk": "dimos.robot.drone.blueprints.basic.drone_px4_swarm_hardware_rtk:drone_px4_swarm_hardware_rtk",
    "drone-px4-swarm-hardware-rtk-agentic": "dimos.robot.drone.blueprints.agentic.drone_px4_swarm_hardware_rtk_agentic:drone_px4_swarm_hardware_rtk_agentic",
    "drone-px4-swarm-sitl": "dimos.robot.drone.blueprints.basic.drone_px4_swarm_sitl:drone_px4_swarm_sitl",
    ...
    "drone-tello-tt-fleet-agentic": "dimos.robot.drone.blueprints.agentic.drone_tello_tt_fleet_agentic:drone_tello_tt_fleet_agentic",
    "drone-tello-tt-gesture": "dimos.robot.drone.blueprints.basic.drone_tello_tt_gesture:drone_tello_tt_gesture",
...
all_modules = {
    ...
    "px4-swarm-module": "dimos.robot.drone.px4_swarm_module",
    ...
    "tello-fleet-module": "dimos.robot.drone.tello_fleet_module",
    "tello-gesture-control-module": "dimos.robot.drone.tello_gesture_control_module",
